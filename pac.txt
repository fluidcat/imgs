...
var lastRule = '';
var proxy = 'SOCKS5 10.1.1.51:7890';
...
////////////////////////////////// 科学上网 开始 //////////////////////////////////
function findAutoProxy(url, host) {
...
var proxy_fiddler = "PROXY 10.1.1.51:8888; DIRECT;";

var direct = 'DIRECT';

function findFiddlerProxy(url, host) {
    var lastPos;
    do {
        if (domains_fiddler.hasOwnProperty(host)) {
            return proxy_fiddler;
        }
...
function FindProxyForURL(url, host) {
    return findFiddlerProxy(url, host) || findAutoProxy(url, host) || direct;
}
